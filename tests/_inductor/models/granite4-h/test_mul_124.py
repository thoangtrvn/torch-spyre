...
def SimpleIterate(device=None):
    ...
    var0 = torch.rand(torch.Size([1, 11, 1024]), dtype=torch.float16).to(device)
    var1 = torch.rand(torch.Size([1, 11, 1024]), dtype=torch.float16).to(device)
    inputs = [var0, var1]
